 ...
 * Should include methods that will be useable in the gui version of the program
 * such as methods to read from a database and/or process the information
 * obtained there.
 *
 * @author Michael
 */
public class Viewer
{
    ...
    /**
     * IO method for reading in all reservations in a database file
     *
     ...
     * @return arrayOfNames array containing all names in the array passed in
     */
     ...
     * method is just a redirection of the FileSort.pickFile(), but this is done
     * to simplify method calls so that all of the program logic is called from
     * a dedicated logic class
     *
