...
public class ReservationSort
{
     ...
     * array will be sorted by name. If the int is a 1, the array will be sorted
     * by arrival date. if the int is a 2, the array will be sorted by departure
     * date.
     *
     ...
     * the elements sorted are less than 4, then it is going to sort them by
     * insertion sort
     *
