...
public class ReservationGUI extends JFrame
{
    ...
    /**
     * Constructor for ReservationGUI contains listener class as well as creates
     * the user interface. Anything that needs to be done before program
     * displays goes here.
     */
    public ReservationGUI()
    {
        ...
        class UserSelection implements ActionListener
        {
            ...
            /**
             * Listener method. Catches the event after it is fired by the
             * object. Listens for: load JFileChooser searchByComboBox
             * printButton backButton searchDateJButton yearComboBox
             * monthComboBox
             *
             * @param event
             */
            ...
            public void actionPerformed(ActionEvent event)
            {
                ...
                if (event.getSource() == searchByComboBox)
                {
                    goBackPage();
                    searchBar.setText("");
                    CardLayout c2 = (CardLayout) searchCardLayoutPanel.
                            getLayout();
        ...
        /**
         * Listener to determine if/what a user is typing in the searchBar text
         * field and find the names that starts with it in the database Listens
         * for: searchBar
         */
        class TextFieldListener implements CaretListener
        {
            ...
            /**
             * Takes input from the text field after each key press and searches
             * the database for any names that start with the contents of the
             * search bar.
             *
        ...
        class ListListener implements ListSelectionListener
        {
            ...
            /**
             * Listener grabs contents of selection and matches it to the
             * reservation database. displaying all reservations under the
             * selected name.
             *
    ...
    /**
     * create menu bar and adds it to the JFrame to allow user to load a
    ...
    /**
     * Simple method to get the number of days in a given month/year using
     * DateAD as an object
     *
    ...
    /**
     * Method for setting up the card layout of the searching methods creates
     * the model for Month and year comboboxes and calls getDaysInMonth to
    ...
    /**
     * Create the UI of the JFrame. Initializes all panels and layouts. Called
     * by the constructor to initialize all components.
     */
    ...
    /**
     * Sets the arrays. Sets arrays sorted by name, by name case-insensitive, by
     * arrival, or by departure.
     *
    ...
    /**
     * Method to assist in searching the database by date calls searchForAll in
     * the BinarySearch class to display all reservations
     *
    ...
    /**
     * Displays ALL reservations in the database into the reservationJList call
    ...
    /**
     * Helper method to display all reservations in reservationJList. Displays
     * all reservations in the JList.
     *
     * @param reservationsToDisplay (Reservation) array of all reservations in
     * the database
     */
